...
function TestWebDriverPromiseModule() {
  ...
  protractor.promise.asap(promise, function (value : any) {
    return true;
  });
  protractor.promise.asap(promise, function (value : any) {
  }, function (err : any) {
  ...
  promise = protractor.promise.checkedNodeCall(function (err : any, value : any) {
    return 123;
  });
  ...
  promise = protractor.promise.when(promise, function (value : any) {
    return 123;
  }, function (err : Error) {
    return 123;
  });
...
function TestWebDriverUntilModule() {
  var conditionB : protractor.until.Condition<boolean> = new protractor.until.Condition<boolean>('message', function (driver : webdriver.WebDriver) {
    return true;
  });
...
function TestProtractor() {
  ...
  var promise : protractor.promise.Promise<any> = ptor.call(function (a : number, b : number, c : number) {
  }, this, 1, 2, 3);
  ...
  promise = ptor.executeAsyncScript(function (a : number, b : number, c : number) {
  }, 1, 2, 3);
  ...
  promise = ptor.executeScript(function (a : number, b : number, c : number) {
  }, 1, 2, 3);

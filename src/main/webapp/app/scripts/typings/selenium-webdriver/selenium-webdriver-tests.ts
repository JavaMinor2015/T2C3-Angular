...
function TestCommandExecutor() {
  var c : webdriver.CommandExecutor = {
    execute: function (command : webdriver.Command, callback : (error : Error, obj : any) => any) {
    }
  };
...
function TestWebDriver() {
  ...
  stringPromise = driver.call<string>(function (a : number) {
    return 'value';
  }, driver, 1);
  ...
  stringPromise = driver.executeAsyncScript<string>(function (a : number) {
  }, 1);
  ...
  stringPromise = driver.executeScript<string>(function (a : number) {
  }, 1);
  ...
  booleanPromise = driver.wait(function (driver : webdriver.WebDriver) {
    return true;
  });
...
function TestWebElementPromise() {
  ...
  elementPromise.thenCatch(function (error : any) {
...
function TestPromiseModule() {
  ...
  webdriver.promise.asap('abc', function (value : any) {
    return true;
  });
  webdriver.promise.asap('abc', function (value : any) {
  }, function (err : any) {
  ...
  stringPromise = webdriver.promise.checkedNodeCall<string>(function (err : any, value : any) {
    return 'abc';
  });
  ...
  stringPromise = webdriver.promise.createFlow<string>(function (newFlow : webdriver.promise.ControlFlow) {
    return 'ABC'
  });
  ...
  numberPromise = webdriver.promise.when('abc', function (value : any) {
    return 123;
  }, function (err : Error) {
    return 123;
  });
...
function TestUntilModule() {
  ...
  var conditionB : webdriver.until.Condition<boolean> = new webdriver.until.Condition<boolean>('message', function (driver : webdriver.WebDriver) {
    return true;
  });
...
function TestControlFlow() {
  ...
  var stringPromise : webdriver.promise.Promise<string>;
  stringPromise = flow.execute(function () {
    return 'value';
  });
  stringPromise = flow.execute(function () {
    return stringPromise;
  ...
  voidPromise = flow.wait<void>(function () {
    return true;
  });
  voidPromise = flow.wait<void>(function () {
    return true;
...
function TestPromiseClass() {
  ...
  var promise : webdriver.promise.Promise<string>;
  promise = new webdriver.promise.Promise<string>(function (onFulfilled : (value : string)=>void,
                                                            onRejected : ()=>void) {
  });
  promise = new webdriver.promise.Promise<string>(function (onFulfilled : (value : webdriver.promise.Promise<string>)=>void,
                                                            onRejected : ()=>void) {
  });
  promise = new webdriver.promise.Promise<string>(function (onFulfilled : (value : string)=>void,
                                                            onRejected : ()=>void) {
